...
<div class="box">
    ...
    <form id="LoginForm" action="FrontController" method="post">
        ...
        <input type="text" name="userloginLog" placeholder="Username" autocomplete="off" required>
        <input type="password" name="passwordLog" placeholder="Password" autocomplete="off" required>
    ...
    <form id="RegForm" action="FrontController" method="post" style="display: none;">
        ...
        <input type="text" name="userlastname" placeholder="Lastname" autocomplete="off" required>
        <input type="password" name="password" placeholder="Password" autocomplete="off" required>
        <input type="password" name="checkPassword" placeholder="Repeat password" autocomplete="off" required>
